...
parser.add_argument('-k', '--kmer', dest='KMER_SIZE', metavar='STR', default='5p6', help='Kmer size to perform kmer based clustering. default: 5p6-mer')
...
parser.add_argument('-o', '--output', dest='OUTPUT_DIR', metavar='STR', default='karma_output', help='Output directory.')
parser.add_argument('-t', '--threads', dest='THREADS', type=int, metavar='INT', default=6, help='Threads to use. (default: 6)')

parser.add_argument('--inflation', dest='INFLATION', type=int, metavar='INT', default=1.4, help='Inflation value for mcl clustering. Between 1.2 and 6. (default: 1.4)')
